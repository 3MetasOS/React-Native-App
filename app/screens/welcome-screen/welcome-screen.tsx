  ...
  return (
    <View style={FULL}>
      ...
      <Screen style={CONTAINER} preset="scroll" backgroundColor={color.transparent}>
        ...
        <Text style={CONTENT}>
          This sample was developed by 3Metas. Using React Navigation 4 for Drawer, Tab and Stack Navegation. 
        </Text>
        <Text style={CONTENT}>
        ...
        <Text style={CONTENT}>
          Live preview of your fully functioning app using Ignite.
        </Text>
      </Screen>
